...
function parseSentences(text) {
  wordStrands = text.split(/[.?!]+/);
  trimEnds(wordStrands, '');

  punctuation = text.split(/[^.?!]+/);
  trimEnds(punctuation, '');

  return combine(wordStrands, punctuation);
}
